...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-brand-light-teal flex flex-col items-center justify-center p-8">
      <h1 className="text-4xl font-bold text-brand-dark-blue mb-8">About Us</h1>
      <p className="text-brand-text mb-8 text-lg text-center max-w-md">
        [This is the About Us page. You can share your mission, vision, and team information here.]
      </p>
